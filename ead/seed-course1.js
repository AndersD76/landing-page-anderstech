...
<div class="quiz-inline" data-correct="c" data-fb-ok="Correto! A norma exige que a alta direção demonstre lideranca e comprometimento com ações concretas, não apenas delegue ao RD." data-fb-nok="Incorreto. Na ISO 9001:2015, a responsabilidade e da alta direção — ela deve demonstrar comprometimento ativo, não apenas nomear um responsável."><div class="qi-title"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg> Teste seu conhecimento</div><div class="qi-question">Qual é a principal exigência da cláusula 5.1 sobre lideranca?</div><button class="qi-option" data-key="a">Nomear um Representante da Direção (RD) para cuidar do SGQ</button><button class="qi-option" data-key="b">Publicar a politica da qualidade no site da empresa</button><button class="qi-option" data-key="c">A alta direção deve demonstrar lideranca e comprometimento com ações concretas</button><div class="qi-feedback"></div></div>
...
<div class="callout"><strong>Importante:</strong> A auditoria interna deve ser vista como uma ferramenta de MELHORIA, não de PUNICAO. Se as pessoas tiverem medo da auditoria, vao esconder problemas em vez de mostrá-los. A cultura da organização deve incentivar a transparência: encontrar um problema na auditoria e BOM — significa que podemos corrigi-lo antes que vire uma reclamação do cliente ou uma não conformidade na auditoria de certificação.</div>
